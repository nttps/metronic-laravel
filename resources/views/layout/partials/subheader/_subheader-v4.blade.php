            ...
            <div class="input-group input-group-sm input-group-solid" style="max-width: 175px">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        {{ Metronic::getSVG("vendor/metronic/media/svg/icons/General/Search.svg", "svg-icon-md") }}
                    </span>
                </div>
            </div>
        </div>
        <div class="d-flex align-items-center">
            @if (config('layout.subheader.displayDaterangepicker'))
                <a href="#" class="btn btn-light btn-sm font-weight-bold mr-2" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="Select dashboard daterange" data-placement="left">
                    ...
                    {{ Metronic::getSVG("vendor/metronic/media/svg/icons/Communication/Chat-check.svg", "svg-icon-sm svg-icon-primary ml-1") }}
                </a>
            @endif
            ...
            <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                    @include('metronic::layout.partials.content.dropdowns._dropdown-2')
                </div>
            </div>
        </div>
    </div>
