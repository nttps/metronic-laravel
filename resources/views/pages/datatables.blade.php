...
{{-- Styles Section --}}
@section('styles')
    <link href="{{ asset('vendor/metronic/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('scripts')
    {{-- vendors --}}
    <script src="{{ asset('vendor/metronic/plugins/custom/datatables/datatables.bundle.js') }}" type="text/javascript"></script>

    {{-- page scripts --}}
    <script src="{{ asset('vendor/metronic/js/pages/crud/datatables/basic/basic.js') }}" type="text/javascript"></script>
@endsection
