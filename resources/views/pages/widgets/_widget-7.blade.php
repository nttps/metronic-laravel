...
<div class="card card-custom {{ @$class }}">
    ...
    <div class="card-body pt-2">
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{ asset('vendor/nttps/metronic-laravel/media/svg/avatars/009-boy-4.svg') }}" class="h-75 align-self-end"/>
                </span>
            </div>
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{ asset('vendor/nttps/metronic-laravel/media/svg/avatars/006-girl-3.svg') }}" class="h-75 align-self-end"/>
                </span>
            </div>
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{ asset('vendor/nttps/metronic-laravel/media/svg/avatars/011-boy-5.svg') }}" class="h-75 align-self-end"/>
                </span>
            </div>
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{ asset('vendor/nttps/metronic-laravel/media/svg/avatars/015-boy-6.svg') }}" class="h-75 align-self-end"/>
                </span>
            </div>
        ...
        <div class="d-flex align-items-center mb-2">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="{{ asset('vendor/nttps/metronic-laravel/media/svg/avatars/016-boy-7.svg') }}" class="h-75 align-self-end"/>
                </span>
            </div>
