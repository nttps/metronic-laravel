    ...
    <div class="card-body pt-8">
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-primary mr-5">
                <span class="symbol-label">
                    {{ Metronic::getSVG("vendor/nttps/metronic-laravel/media/svg/icons/Home/Library.svg", "svg-icon-lg svg-icon-primary") }}
                </span>
            </div>
        ...
        <div class="d-flex align-items-center mb-10">
            ...
            <div class="symbol symbol-40 symbol-light-danger mr-5">
                <span class="symbol-label">
                    {{ Metronic::getSVG("vendor/nttps/metronic-laravel/media/svg/icons/General/Attachment2.svg", "svg-icon-lg svg-icon-danger") }}
                </span>
            </div>
